...
.page-wrapper {
  @apply ease-out grow z-$zPageWrapper p-$PageWrapper-padding items-center;
  ...
  &__content {
    @apply flex flex-col grow p-$PageWrapper-content-padding max-w-$PageWrapper-content-width w-full overflow-auto;
  }
}
